...
The `icpsr_download` function (1) opens a Chrome browser and navigates to the ICPSR login page (2) enters the required information and logs in, (3) navigates to a specified dataset's download page and agrees to the terms and conditions of the download, (4) downloads the dataset's files, and, (4) decompresses the dataset's files to a subdirectory within a specified directory (or, by default, a `icpsr_data` directory in the current working directory).
